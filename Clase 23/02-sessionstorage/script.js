// Si el navegador no soporta sessionStorage, window.sessionStorage será igual a "undefined". Javascript interpreta "undefined" como false
if(window.sessionStorage) {
	...
	seleccionColor.addEventListener("change", function(e){
		...
		window.sessionStorage.colorUsuario = seleccionColor.value;
	});

	// Recuperar el valor del color previamente seleccionado por el usuario
	var colorSeleccionado = window.sessionStorage.colorUsuario;
